...
<div class="container my-3">
    <h3 class="my-3 text-center">Tambah Foto Galeri</h3>
    <form action="/admin/galeri" method="post" enctype="multipart/form-data">
        @csrf
     
    <div class="row mb-3">        
        <label for="gambar" class="col-sm-2 col-form-label">Foto Galeri</label>
    ...
    <a href="/admin/galeri" class="btn btn-danger  float-end">Batal</a>      
