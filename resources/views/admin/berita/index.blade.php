...
<a href="news/create" class="btn btn-success mb-2 mt-2 float-end"><i class="fa fa-plus" aria-hidden="true"></i> Berita Baru</a>

@php
$heads = [
    ['label' => '#', 'width' => 3],
    ['label' => 'Gambar', 'width' => 20],
    ['label' => 'Judul Berita', 'width' => 30],
    ...
    @foreach($berita as $p)
        <tr>
          ...
          <td class="align-middle">
            <a href="news/{{ $p->id }}/edit" class="btn btn-outline-info btn-sm"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
            <form action="news/{{ $p-> id }}" method="post" class="d-inline">
              @method('delete')
              @csrf
