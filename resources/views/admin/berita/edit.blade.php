...
<div class="container my-3">
    ...
    <form action="/admin/news/{{ $berita->id }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf
    <div class="row mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            ...
            @endphp
            <x-adminlte-input-date name="rilis" :config="$config" placeholder="Choose a date..." value="{{ old('rilis',$berita->rilis) }}">
    ...
    <div class="row mb-3">        
        ...
        <div class="col-sm-10">
            <input class="form-control" type="file" id="gambar" name="gambar" onchange="previewImg()" value="{{ old('gambar',$berita->gambar) }}">        
        </div>
    </div>
    <div class="row mb-3">
