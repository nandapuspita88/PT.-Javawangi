...
<a href="solusi/create" class="btn btn-success mb-2 mt-2 float-end"><i class="fa fa-plus" aria-hidden="true"></i> Artikel Baru</a>
    ...
    @foreach($solusi as $p)
        <tr>
          ...
          <td class="align-middle">
            <a href="solusi/{{ $p->id }}/edit" class="btn btn-outline-info btn-sm"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
            <form action="solusi/{{ $p-> id }}" method="post" class="d-inline">
              @method('delete')
              @csrf
